...
export const BIO = `Lucila Heinberg (Buenos Aires, 1979). Estudió Dirección de Fotografía (SICA), y con distintos artistas, como Adriana Lestido, Lorena Fernández, Alberto Goldenstein, Proyecto Imaginario, Fabiana Barreda, Ignacio Iasparra, entre otros. Se dedica a la fotografía y se desempeña como docente de prácticas analógicas en revelado color manual. Ha realizado muestras individuales, entre ellas, en la Fotogalería del Teatro San Martín, y ha participado de muestras y publicaciones colectivas. En el año 2012 recibió el Premio Felifa (La Luminosa), por el cual editaron su primer libro, Ahora. En ese mismo año recibió una Mención del Salón Nacional de las Artes Visuales. En agosto de 2021 autopublicó su segundo libro, Bardo.`;
